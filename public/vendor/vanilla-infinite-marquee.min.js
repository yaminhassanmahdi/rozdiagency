...
class InfiniteMarquee {
    ...
    if (
      ...
      if (
        ...
        window.matchMedia("(prefers-reduced-motion: reduce)").matches &&
          ((this.animateMotion = !1),
          this.debugging &&
            console.log(
              '🚊 Infinite Marquee - "prefers-reduced-motion" is Reduced'
            )),
        ...
        this.debugging &&
          console.log("🚊 Infinite Marquee - DOM Nodes Created from Array");
      } else
        (this.isMarqueeInitialized = !0),
          ...
          this.debugging &&
            console.log(
              "🚊 Infinite Marquee - DOM Nodes Created from Single Element"
            );
  ...
  configureChildNodes(e) {
    ...
    e.classList.add(`${this.scrollType}-marquee`),
      ...
      this.debugging &&
        console.log("🚊 Infinite Marquee - DOM Nodes Appended Successfully");
  }
  duplicateOriginalNodes(e) {
    ...
    this.debugging &&
      console.log("🚊 Infinite Marquee - DOM Nodes Duplicated Successfully");
  }
    ...
    const i = (e) => {
      ...
      s = () => {
        if (this.isMarqueeInitialized) {
          ...
          if (
            (e.style.setProperty("--_speed", `${l}ms`),
          ...
          window.innerWidth >= this.desktopBreakpoint &&
            ...
            i(e),
            this.debugging &&
              console.log(`🚊 Infinite Marquee - ${this.scrollType} type`),
            this.debugging &&
              console.log("🚊 Infinite Marquee - Animation Configs Ready");
        }
      };
  ...
  manageMarquee(e, t) {
    this.isMarqueeInitialized &&
      ...
      (this.isMarqueeInitialized = !1),
      this.debugging &&
        console.log("🚊 Infinite Marquee - Destroyed Successfully"));
  }
...
// Remove the ES module export and attach to window for global usage
